...
describe('Testing xml2js.js:', function () {
    ...
    describe('Various options:', function () {
        ...
        describe('options = {compact: true, addId: true}', function () {

            var options = {compact: true, addId: true};
            it('Has id', function () {
                expect(convert.xml2js('<a>123</a>', options).a._id).toBeTruthy();
            });

        });

        describe('options = compact: true, addId: true, idKey: "xId"', function () {

            var options = {compact: true, addId: true, idKey: 'xId'};
            it('Has xId', function () {
                expect(convert.xml2js('<a>123</a>', options).a.xId).toBeTruthy();
            });
