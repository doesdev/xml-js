...
function validateOptions (userOptions) {
    ...
    common.ensureFlagExists('addId', options);
    common.ensureFlagExists('addParent', options);
    common.ensureFlagExists('addParentId', options);
    ...
    common.ensureKeyExists('id', options);
    common.ensureKeyExists('parentId', options);
    return options;
}
...
function onStartElement (name, attributes) {
    ...
    if (options.compact) {
        element = {};
        if (options.addId) {
            element[options.idKey] = common.idGen();
            if (options.addParentId) element[options.parentIdKey] = currentElement[options.idKey];
        }
